...
public class NPDBSIPRClientOperacion {

    private int PORT; // = 11610;
    private String SERVER; // = "172.18.248.245";
    //private String PRIMITIVA; // = "operacion";
    private int tipo_operacion;
    private String msisdn;
    private int operadora;
    
        public NPDBSIPRClientOperacion(String ip, int port, int operacion, String numero, int oper){
    ...
    public static void main(String[] args) {
        ...
        NPDBSIPRClientOperacion cliente;

        if ((args.length > 6) || (args.length < 5)) {
                System.out.println("Invalid parameters.");
                System.out.println("Usage:");
                System.out.println("          NPDBSIPRClientOperacion <ip> <port> <tipo_operacion> <msisdn> <operadora>");
                System.out.println("          tipo_operacion: 0-alta; 1-baja; 2-modificacion");
                System.exit(-1);
        }

        cliente = new NPDBSIPRClientOperacion(args[0], Integer.parseInt(args[1]), Integer.parseInt(args[2]), args[3], Integer.parseInt(args[4]));
        cliente.exec();
    ...
    public void exec(){
        ...
        try {            
            ...
            operacionNpdb.setTipoOperacion(new TipoOperacionPortabilidad(tipo_operacion)); //0-alta; 1-baja; 2-actualizacion
            operacionNpdb.setNumTelefono(new NumTelefono(msisdn.getBytes("UTF-8")));
            operacionNpdb.setOperadora(new Operadora(operadora)); // NRN
